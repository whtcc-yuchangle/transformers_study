...
def prepare_dataloader():
    ...
    trainloader = DataLoader(trainset, batch_size=128, collate_fn=collate_func, shuffle=True)
    validloader = DataLoader(validset, batch_size=256, collate_fn=collate_func, shuffle=False)
...
def train(model, optimizer, trainloader, validloader, accelerator: Accelerator, epoch=5, log_step=20):
    global_step = 0
